    ...
    <section className={styles.firstScreen} id="main">
      <div className={styles.firstScreen_wrapper_block}>
        <div className={styles.firstScreen_block}>
          ...
          >
            Утеплитель
            <span className={styles.firstScreen_span}> ISOVER</span>
            <br></br>Высокое качество по доступной цене от{" "}
            <span className={styles.firstScreen_span}> 571 руб/шт</span>
          </motion.h1>
          <motion.p
            initial="initial"
            animate="animate"
          ...
          >
            Минеральный утеплитель Isover – материал, обладающий высокой
